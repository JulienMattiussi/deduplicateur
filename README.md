...
```bash
# Moteur Rust (221 tests)
cargo test --manifest-path src-tauri/Cargo.toml

# TypeScript - utilitaires + i18n + composants React (334 tests)
npm test
```
